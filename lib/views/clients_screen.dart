...
class ClientScreen extends StatelessWidget {
  ...
  final CreateNewClientController createNewClientController = Get.put(CreateNewClientController());
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      onPopInvokedWithResult: (bool didPop, Object? result) {
        clientsController.disposeController();
        createNewClientController.disposeController();
      },
      child: Scaffold(
